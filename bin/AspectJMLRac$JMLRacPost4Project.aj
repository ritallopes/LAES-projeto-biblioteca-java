...
public static aspect UtilPreconditionChecking_Cliente$62458c6c_b710_48f7_92be_d41152a6372e{
  before(): (execution( * model.Cliente..*+.*(..))
          || execution(model.Cliente..*+.new(..))
          || execution( * model.Cliente+.*(..))
          || execution(model.Cliente+.new(..))){
...
public static aspect UtilPreconditionChecking_Emprestimo$098f0430_3603_494d_ae9b_a97762442743{
  before(): (execution( * model.Emprestimo..*+.*(..))
          || execution(model.Emprestimo..*+.new(..))
          || execution( * model.Emprestimo+.*(..))
          || execution(model.Emprestimo+.new(..))){
    JMLChecker.hasAnyThrownPrecondition();
...
public static aspect UtilPreconditionChecking_Livro$e159af6e_0cff_41da_ad06_aa40c3403fcc{
  before(): (execution( * model.Livro..*+.*(..))
          || execution(model.Livro..*+.new(..))
          || execution( * model.Livro+.*(..))
          || execution(model.Livro+.new(..))){
    JMLChecker.hasAnyThrownPrecondition();
...
public static aspect UtilPreconditionChecking_Multa$7dee6561_f6fe_4af6_b5cf_4030dadb165c{
  before(): (execution( * model.Multa..*+.*(..))
          || execution(model.Multa..*+.new(..))
          || execution( * model.Multa+.*(..))
          || execution(model.Multa+.new(..))){
    JMLChecker.hasAnyThrownPrecondition();
...
public static aspect UtilPreconditionChecking_BdCliente$0340dac5_0690_459d_8265_7a0d054463e5{
  before(): (execution( * utils.BdCliente..*+.*(..))
          || execution(utils.BdCliente..*+.new(..))
          || execution( * utils.BdCliente+.*(..))
          || execution(utils.BdCliente+.new(..))){
    JMLChecker.hasAnyThrownPrecondition();
...
public static aspect UtilPreconditionChecking_BdEmprestimo$508b7bdf_2dda_45d0_ace8_c6f5682e976b{
  before(): (execution( * utils.BdEmprestimo..*+.*(..))
          || execution(utils.BdEmprestimo..*+.new(..))
          || execution( * utils.BdEmprestimo+.*(..))
          || execution(utils.BdEmprestimo+.new(..))){
    JMLChecker.hasAnyThrownPrecondition();
...
public static aspect UtilPreconditionChecking_BdLivro$964345be_d6a7_44b8_b2ce_81112e9abe5f{
  before(): (execution( * utils.BdLivro..*+.*(..))
          || execution(utils.BdLivro..*+.new(..))
          || execution( * utils.BdLivro+.*(..))
          || execution(utils.BdLivro+.new(..))){
    JMLChecker.hasAnyThrownPrecondition();
...
public static aspect UtilPreconditionChecking_BdMulta$5c74f038_a9f0_40ea_8010_316eadaad8e8{
  before(): (execution( * utils.BdMulta..*+.*(..))
          || execution(utils.BdMulta..*+.new(..))
          || execution( * utils.BdMulta+.*(..))
          || execution(utils.BdMulta+.new(..))){
    JMLChecker.hasAnyThrownPrecondition();
